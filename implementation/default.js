/*
 *
 *    update.js drives the dynamic content of the generic home page
 *
 */
$(function() {
	...
	/*
	 *    PROMPT USER TO CREATE ACCOUNT WHEN SAVE ATTEMPT MADE
	 */
	setInterval(function(){
		
		$("#save").click(function() {
			
			alert("Create an account or sign in to start saving your queries!");
		});
